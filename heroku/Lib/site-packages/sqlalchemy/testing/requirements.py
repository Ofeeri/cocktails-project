...
class SuiteRequirements(Requirements):
    ...
    def sane_rowcount(self):
        return exclusions.skip_if(
            lambda config: not config.con.dialect.supports_sane_rowcount,
    ...
    def sane_multi_rowcount(self):
        return exclusions.fails_if(
            lambda config: not config.con.dialect.supports_sane_multi_rowcount,
    ...
    def sane_rowcount_w_returning(self):
        return exclusions.fails_if(
            lambda config: not (
                config.con.dialect.supports_sane_rowcount_returning
            ),
    ...
    def empty_inserts(self):
        ...
        return exclusions.only_if(
            lambda config: config.con.dialect.supports_empty_insert
            or config.con.dialect.supports_default_values,
    ...
    def returning(self):
        ...
        return exclusions.only_if(
            lambda config: config.con.dialect.implicit_returning,
    ...
    def denormalized_names(self):
        ...
        return exclusions.skip_if(
            lambda config: not config.con.dialect.requires_name_normalize,
    ...
    def multivalues_inserts(self):
        ...
        return exclusions.skip_if(
            lambda config: not config.con.dialect.supports_multivalues_insert,
    ...
    def server_side_cursors(self):
        ...
        return exclusions.only_if(
            [lambda config: config.con.dialect.supports_server_side_cursors],
    ...
    def sequences(self):
        ...
        return exclusions.only_if(
            [lambda config: config.con.dialect.supports_sequences],
            "no sequence support",
        )
    ...
    def sequences_optional(self):
        ...
        return exclusions.only_if(
            [
                lambda config: config.con.dialect.supports_sequences
                and config.con.dialect.sequences_optional
            ],
    ...
    def supports_lastrowid(self):
        ...
        """
        return exclusions.only_if(
            [lambda config: config.con.dialect.postfetch_lastrowid]
        )
    ...
    def supports_is_distinct_from(self):
        ...
        """
        return exclusions.skip_if(
            lambda config: not config.con.dialect.supports_is_distinct_from,
